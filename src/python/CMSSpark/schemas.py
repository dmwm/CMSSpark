...
def schema_cmssw():
    ...
    {"UNIQUE_ID":{"string":"08F8DD3A-0FFE-E611-B710-BC305B3909F1-1"},
     "FILE_LFN":{"string":"/store/data/Run2016F/JetHT/AOD/23Sep2016-v1/70000/XXXX.root"},
     "FILE_SIZE":{"string":"3865077537"},"CLIENT_DOMAIN":{"string":"in2p3.fr"},"CLIENT_HOST":{"string":"sbgwn141"},
     "SERVER_DOMAIN":{"string":"in2p3.fr"},"SERVER_HOST":{"string":"sbgse20"},"SITE_NAME":{"string":"T2_FR_IPHC"},
     "READ_BYTES_AT_CLOSE":{"string":"438385807"},"READ_BYTES":{"string":"438385807"},
     "READ_SINGLE_BYTES":{"string":"8913451"},"READ_SINGLE_OPERATIONS":{"string":"19"},
     "READ_SINGLE_AVERAGE":{"string":"469129"},"READ_SINGLE_SIGMA":{"string":"1956390"},
     "READ_VECTOR_BYTES":{"string":"429472356"},"READ_VECTOR_OPERATIONS":{"string":"58"},
     "READ_VECTOR_AVERAGE":{"string":"7404700"},"READ_VECTOR_SIGMA":{"string":"6672770"},
     "READ_VECTOR_COUNT_AVERAGE":{"string":"37.4138"},"READ_VECTOR_COUNT_SIGMA":{"string":"35.242"},
     "FALLBACK":{"string":"-"},
     "USER_DN":{"string":"/DC=ch/DC=cern/OU=Organic Units/OU=Users/CN=xxx/CN=1/CN=Name/CN=1/CN=1/CN=1/CN=1/CN=1"},
     "APP_INFO":{"string":"3809_https://glidein.cern.ch/3809/111111:11111:xxx:crab:JetHT:Run2016F:DSm:4b_0"},
     "START_TIME":{"string":"1488325657"},"END_TIME":{"string":"1488326400"},"START_DATE":{"long":1488322057000},
     "END_DATE":{"long":1488322800000},"INSERT_DATE":{"long":1488323999000}
    }
    """
    return StructType([
