...
def get_raw_df(spark, start_date, end_date):
    ...
    df_raw = (
        spark.read.option(
            ...
            | ((col('Site') == 'T1_IT_CNAF') & (col('MachineAttrCMSSubSiteName0').isin(['CNAF-CINECA', 'CNAF-ARM'])))  # CINECA
            ...
            .when(col('MachineAttrCMSSubSiteName0').isin(['CNAF-CINECA', 'CNAF-ARM']), lit("CINECA"))
