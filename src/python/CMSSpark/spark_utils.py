...
def aaa_tables(sqlContext,
    ...
    by us and integrated in the MONIT infrastructure, see
    https://cern.service-now.com/service-portal/view-request.do?n=RQF0856987
...
def eos_tables(sqlContext,
    ...
    into the MONIT infrastructure, see
    https://cern.service-now.com/service-portal/view-request.do?n=RQF0856987
