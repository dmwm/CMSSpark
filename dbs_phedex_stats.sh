...
#cmd="./dbs_phedex_spark --fout=datasets.csv --antipatterns=$apatterns --yarn --verbose --amq=$amq"
cmd="./dbs_phedex_spark --fout=datasets.csv --antipatterns=$apatterns --yarn --verbose"
