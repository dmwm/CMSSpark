#!/bin/bash
# This script set up the environment and run the condor_hs06coreHrPlot.py
...
# See https://github.com/dmwm/CMSSpark/blob/master/doc/scripts/HS06CPUTimePlot_script.md
# for mor details.
