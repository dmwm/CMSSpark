#!/bin/bash
# This script set up the environment and run the hpc_at_cms.py
...
# See https://its.cern.ch/jira/browse/CMSMONIT-341 for mor details.
...
"$currentDir/../src/python/CMSSpark/hpc_at_cms.py" "$@"
